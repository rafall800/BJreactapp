...
import { TextBlock } from '../../../components/textFormatingStyles/TextBlock.styles';
import { Header3 } from '../../../components/textStyles/Header3.styles';
import { Paragraph } from '../../../components/textStyles/Paragrapsh.styles';
import { getCards } from '../../../utils/functions';
import { ListElement } from '../../LandingPage/LandingPageContent/LandingPageContent.styles';
import { Row, CardsBox, Flex } from './HowToCountCards.styles';
import RoundPreview from '../../../assets/previews/DecisionMaking.png';
import { ArticleBox } from '../../../components/textFormatingStyles/ArticleBox.styles';
        ...
        <ul>
          ...
          <ListElement>
            <Paragraph>
              ...
              basic strategy is to bet the lowest amount possible times (“True Count”-1).
            </Paragraph>
          </ListElement>
        </ul>
      </TextBlock>
